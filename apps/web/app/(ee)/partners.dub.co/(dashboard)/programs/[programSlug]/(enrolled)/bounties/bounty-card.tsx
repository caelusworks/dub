...
export function PartnerBountyCard({
  ...
  return (
    <As
      href={href ?? "#"}
      onClick={onClick}
      className="group relative flex w-full cursor-pointer flex-col overflow-hidden rounded-xl border border-border-subtle bg-bg-default text-left transition-all hover:border-border-default hover:shadow-lg"
    >
