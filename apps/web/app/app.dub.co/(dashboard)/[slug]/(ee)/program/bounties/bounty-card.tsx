...
export function BountyCard({ bounty }: { bounty: BountyListProps }) {
  ...
  return (
    <div className="relative cursor-pointer rounded-xl border border-border-subtle bg-white transition-all hover:border-border-default hover:shadow-lg">
      <Link
      ...
      >
        <div className="flex flex-col gap-3.5 p-2 pb-0">
          ...
          <div className="flex flex-col gap-1.5 px-2 pb-3.5">
            ...
            <div className="flex items-center gap-2 text-sm font-normal text-content-subtle">
