        ...
        <div>
          ...
          <div className="relative mt-2 rounded-md shadow-sm">
            ...
            >
              <div
                className={cn(
                  "overflow-hidden rounded-md border border-border-subtle border-neutral-300 shadow-sm focus-within:border-neutral-500 focus-within:ring-1 focus-within:ring-neutral-500",
