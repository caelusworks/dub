    ...
    <Popover
      ...
      content={
        ...
        >
          ...
          >
            <EmojiPickerBase.Search className="z-10 w-full border-0 border-b border-border-default bg-white px-3 py-2.5 text-base outline-none placeholder:text-neutral-400 focus:border-border-default focus:ring-0 sm:rounded-t-lg sm:text-sm" />
              ...
              <EmojiPickerBase.List
                ...
                components={{
                  CategoryHeader: ({ category, ...props }) => (
                    <div
                      className="w-full bg-white px-3 pb-1.5 pt-3 text-xs font-medium text-content-subtle"
                      {...props}
                    >
                      {category.label}
                    </div>
