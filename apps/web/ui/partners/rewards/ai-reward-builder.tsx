    ...
    <div className="relative">
      <AnimatePresence initial={false} mode="popLayout">
        {!builder.isReviewing && (
          ...
          >
            <div
              className="rounded-xl border border-border-subtle bg-white text-sm shadow-sm"
              onFocus={() => {
                setFocused(true);
              }}
            >
              ...
              >
                {focused && (
                  <div className="-mx-px rounded-xl border-x border-t border-border-subtle bg-neutral-100 px-2.5 py-2">
                      ...
                      <div className="flex min-w-0 flex-wrap gap-1.5">
                        {presets.map((preset) => (
                          <button
                            ...
                            className={cn(
                              "inline-flex h-7 w-fit items-center gap-1.5 rounded-lg bg-neutral-200/80 px-2.5 py-2 text-sm font-medium text-content-emphasis",
      ...
      <div className="grid grid-cols-1 grid-rows-1 items-center">
        <AnimatePresence initial={false}>
          {isCreating ? (
            ...
            >
              <span className="text-sm font-medium leading-none text-content-emphasis">
                Generated reward
              </span>
            </motion.div>
          )}
